...
function setup() {
	...
	// Update images' source paths to point to local images in the "../images/flyers" directory
	images.forEach((image, index) => {
		// Example: Set local path based on index, assuming your images are named like "image1.jpg", "image2.jpg", etc.
		image.src = `../images/flyers/image${index + 1}.jpg`;
	});
